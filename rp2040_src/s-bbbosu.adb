...
package body System.BB.Board_Support is
   ...
   Alarm_Interrupt_ID : constant Interrupt_ID :=
     (case RP2040_Runtime_Config.Time_Base is
        when RP2040_Runtime_Config.ALARM0 => 0,  --  TIMER_IRQ_0 (core 0)
        when RP2040_Runtime_Config.ALARM1 => 1,  --  TIMER_IRQ_1 (core 0)
        when RP2040_Runtime_Config.ALARM2 => 2,  --  TIMER_IRQ_2 (core 0)
        when RP2040_Runtime_Config.ALARM3 => 3); --  TIMER_IRQ_3 (core 0)
   ...
   ISER_Core1 : Word := 0 with Volatile;
